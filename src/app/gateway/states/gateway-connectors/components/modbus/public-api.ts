...
///
export * from './modbus-slave-dialog/modbus-slave-dialog.abstract';
export * from './modbus-slave-dialog/modbus-slave-dialog.component';
export * from './modbus-slave-dialog/modbus-legacy-slave-dialog.component';

export * from './modbus-basic-config/modbus-basic-config.component';
export * from './modbus-basic-config/modbus-basic-config.abstract';
export * from './modbus-basic-config/modbus-legacy-basic-config.component';
...
export * from './modbus-value-import-dialog/modbus-value-import-dialog.component';
