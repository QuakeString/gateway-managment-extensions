...
@Component({
  selector: 'tb-ethercat-basic-config',
  templateUrl: './ethercat-basic-config.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => EtherCatBasicConfigComponent),
      multi: true,
    },
    {
  ...
  styleUrls: ['./ethercat-basic-config.component.scss'],
})
export class EtherCatBasicConfigComponent extends GatewayConnectorBasicConfigDirective<EtherCatBasicConfig, EtherCatBasicConfig> {
