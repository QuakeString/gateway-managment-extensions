...
@Component({
  selector: 'tb-iec61850-legacy-basic-config',
  templateUrl: './iec61850-basic-config.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => IEC61850LegacyBasicConfigComponent),
      multi: true,
    },
    {
...
export class IEC61850LegacyBasicConfigComponent extends GatewayConnectorBasicConfigDirective<IEC61850BasicConfig, IEC61850BasicConfig> {
