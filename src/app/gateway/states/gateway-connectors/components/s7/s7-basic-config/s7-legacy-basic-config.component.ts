...
@Component({
  selector: 'tb-s7-legacy-basic-config',
  templateUrl: './s7-basic-config.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => S7LegacyBasicConfigComponent),
      multi: true,
    },
    {
...
export class S7LegacyBasicConfigComponent extends GatewayConnectorBasicConfigDirective<S7BasicConfig, S7BasicConfig> {
